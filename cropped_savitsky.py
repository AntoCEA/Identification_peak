...
def plot_data():
    ...
    try:
        ...
        for idx, file_path in enumerate(file_paths, start=1):  # Start enumeration from 1
            ...
            y_data = savgol_filter(y_data, window_length=51, polyorder=3)
            ...
            try:
                ...
                # Scatter for maximum
                plt.scatter([lambda_max], [A0 + offset], color=spectrum_line.get_color(), marker='o', label=f'Max: λmax={lambda_max:.2f} nm')
